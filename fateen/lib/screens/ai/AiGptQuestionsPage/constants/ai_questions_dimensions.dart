class AiQuestionsDimensions {
  // أحجام العناصر الرئيسية
  ...
  static const double microFontSize = 13.0;
  ...
  static const double optionIndicatorSize = 40.0;
  static const double questionNumberSize = 40.0;
