...
class AiQuestionsLoadingComponent extends StatelessWidget {
  final AiQuestionsController controller;
  final AnimationController loadingController;

  const AiQuestionsLoadingComponent({
    Key? key,
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // رسالة التحميل
            Text(
              controller.generatedQuestionsCount > 0
                  ? "جاري إنشاء السؤال ${controller.generatedQuestionsCount + 1} من ${controller.totalQuestionsToGenerate}..."
                  : "جاري توليد الأسئلة...",
            ...
            // رسالة الانتظار
            Text(
              "قد يستغرق الأمر بضع ثوانٍ، يرجى الانتظار...",
              style: TextStyle(
                fontSize: 14,
