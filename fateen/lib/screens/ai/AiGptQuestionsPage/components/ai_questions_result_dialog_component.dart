...
class AiQuestionsResultDialogComponent extends StatelessWidget {
  final int correctCount;
  final int totalCount;

  const AiQuestionsResultDialogComponent({
    Key? key,
  ...
  Widget build(BuildContext context) {
    ...
    final Color resultColor = _getResultColor(correctCount, totalCount);
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                "انتهيت من الإجابة على جميع الأسئلة، يمكنك مراجعة إجاباتك الآن",
                                style: TextStyle(
                                  fontSize: 13,
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      // نص النتيجة
                      Text(
                        "أجبت على $correctCount من أصل $totalCount بشكل صحيح",
                      ...
                      // رسالة تحفيزية
                      Text(
                        _getMotivationalMessage(correctCount, totalCount),
                        style: TextStyle(
                          fontSize: 14,
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            _buildResultRow("الإجابات الصحيحة", "$correctCount",
                                resultColor),
                            Divider(
                                height: 16,
                                color: Colors.grey.withOpacity(0.3)),
                            _buildResultRow("الإجابات الخاطئة",
                                "${totalCount - correctCount}", Colors.red),
                            Divider(
                                height: 16,
                                color: Colors.grey.withOpacity(0.3)),
  ...
  String _getMotivationalMessage(int correct, int total) {
    final percentage = (correct / total) * 100;

    if (percentage == 100) {
      return "ممتاز! أجبت على جميع الأسئلة بشكل صحيح.";
    } else if (percentage >= 80) {
      return "أداء جيد جدًا. استمر!";
    } else if (percentage >= 60) {
      return "أداء جيد، يمكنك التحسن أكثر.";
    } else {
      return "لا بأس، حاول مرة أخرى للتحسن.";
    }
  }
