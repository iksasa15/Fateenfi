...
class AimingHeaderComponent extends StatelessWidget
              ...
              Positioned(
                ...
                child: Row(
                  children: [
                    ...
                    // زر إعادة الضبط (يظهر فقط عند وجود نتائج)
  ...
  Future<void> _testApiConnection(BuildContext context) async {
    ...
    try {
      await AimingApiService.wakeUpService();
    } catch (e) {
  ...
  void _showConnectionResult(BuildContext context, bool isConnected) {
    final serverInfo = AimingApiService.serverInfo;
    final serverMessage = AimingApiService.lastServerMessage;
            ...
            Text(
              isConnected
                  ? serverMessage.isNotEmpty
                      ? serverMessage
                      : "تم الاتصال بخادم API بنجاح. يمكنك الآن تحليل الصور."
