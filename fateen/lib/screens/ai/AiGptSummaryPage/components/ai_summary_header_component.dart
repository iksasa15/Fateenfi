...
class AiSummaryHeaderComponent extends StatelessWidget
  ...
  const AiSummaryHeaderComponent({
    Key? key,
              ...
              Positioned(
                ...
                child: Row(
                  children: [
                    ...
                    // زر إعادة الضبط (يظهر فقط عند وجود ملخص)
  ...
  Future<void> _testApiConnection(BuildContext context) async {
    ...
    // اختبار الاتصال
    bool isConnected = await AiSummaryApiService.testConnection();
  ...
  void _showConnectionResult(BuildContext context, bool isConnected) {
    final serverInfo = AiSummaryApiService.serverInfo;
  ...
  void _showServerConfigDialog(BuildContext context) {
    final serverInfo = AiSummaryApiService.serverInfo.split(':');
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              if (ip.isNotEmpty) {
                AiSummaryApiService.setServerAddress(ip, port);
