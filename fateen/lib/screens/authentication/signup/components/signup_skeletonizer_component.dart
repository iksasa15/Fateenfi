...
class SignupSkeletonizerComponent extends StatefulWidget {
  final Widget child;
  ...
  const SignupSkeletonizerComponent({
    Key? key,
    required this.child,
  ...
  @override
  State<SignupSkeletonizerComponent> createState() =>
      _SignupSkeletonizerComponentState();
}

class _SignupSkeletonizerComponentState
    extends State<SignupSkeletonizerComponent>
  ...
  Widget build(BuildContext context) {
    ...
    final base = widget.baseColor ?? SignupColors.shimmerBase;
    final highlight = widget.highlightColor ?? SignupColors.shimmerHighlight;
